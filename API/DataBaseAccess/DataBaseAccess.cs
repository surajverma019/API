...
public class DataBaseAccess
{
	...
	{
        //DOCUMENT:  		CommonFunctions.aspx
        //Description:    	commonly used Functions
    	//AUTHOR:			sankarshan parida
    	//E-MAIL: 			sankarshan@hitsindia.com
    	//Developed By:	    Hi Technology & Services, India.
    ...
    public string insert_delete_update_by_storeprocedure1(string storeprocedure_name, string[] parameter_names, string[] parameter_values)
    {
        string res = "";
        try
        {
